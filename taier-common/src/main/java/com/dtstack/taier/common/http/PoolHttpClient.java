...
public class PoolHttpClient {
    ...
    private static CloseableHttpClient getHttpClient() throws Exception {
        ...
        Registry<ConnectionSocketFactory> registry = RegistryBuilder.<ConnectionSocketFactory>create()
                ...
                .register("https", new SSLConnectionSocketFactory(VerifySSLContext.createIgnoreVerifySSL()))
                .build();
    ...
    public static String post(String url, String bodyData, Map<String, Object> cookies, Map<String, Object> headers, Boolean dealWithRespBody) {
        ...
        if (BooleanUtils.isTrue(dealWithRespBody)) {
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpPost)) {
                ...
                log.error("url:" + httpPost.getURI().toString() + "--->http request error:", e);
            }
        }
        return null;
    }
    ...
    private static String execute(HttpPost httpPost) {
        try (CloseableHttpResponse response = httpClient.execute(httpPost)) {
            ...
            if (status == HttpStatus.SC_OK) {
                ...
                log.error("request url:{} fail:{}", httpPost.getURI().toString(), result);
                return null;
            }
            return responseBody;
        } catch (Exception e) {
        ...
        try (CloseableHttpResponse response = httpClient.execute(httpGet);) {
            ...
            if (BooleanUtils.isTrue(dealWithRespBody)) {
                ...
                if (statusCode == HttpStatus.SC_OK) {
                    ...
                    log.error("request url:{} fail:{}", url, result);
                }
                return respBody;
            } else {
                return result;
            ...
            log.error("url:{}--->http request error:{}", url, e);
        }
        return null;
    }
